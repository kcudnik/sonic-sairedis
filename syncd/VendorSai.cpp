...
sai_status_t VendorSai::bulkCreate(
        _In_ uint32_t object_count,
        _In_ const sai_dst_tag_entry_t* entries,
        _In_ const uint32_t *attr_count,
        _In_ const sai_attribute_t **attr_list,
        _In_ sai_bulk_op_error_mode_t mode,
        _Out_ sai_status_t *object_statuses)
{
    ...
    if (!m_apis.dash_tag_api->create_dst_tag_entries)
    {
        SWSS_LOG_INFO("create_dst_tag_entries is not supported");
        return SAI_STATUS_NOT_SUPPORTED;
    }

    return m_apis.dash_tag_api->create_dst_tag_entries(
            object_count,
            entries,
            attr_count,
            attr_list,
...
sai_status_t VendorSai::bulkCreate(
        _In_ uint32_t object_count,
        _In_ const sai_src_tag_entry_t* entries,
        _In_ const uint32_t *attr_count,
        _In_ const sai_attribute_t **attr_list,
        _In_ sai_bulk_op_error_mode_t mode,
        _Out_ sai_status_t *object_statuses)
{
    ...
    if (!m_apis.dash_tag_api->create_src_tag_entries)
    {
        SWSS_LOG_INFO("create_src_tag_entries is not supported");
        return SAI_STATUS_NOT_SUPPORTED;
    }

    return m_apis.dash_tag_api->create_src_tag_entries(
            object_count,
            entries,
            attr_count,
            attr_list,
        ...
        _Out_ sai_status_t *object_statuses)
{
    ...
    if (!m_apis.dash_tag_api->remove_dst_tag_entries)
    {
        SWSS_LOG_INFO("remove_dst_tag_entries is not supported");
        return SAI_STATUS_NOT_SUPPORTED;
    }

    return m_apis.dash_tag_api->remove_dst_tag_entries(
            object_count,
            entries,
            mode,
            object_statuses);
        ...
        _Out_ sai_status_t *object_statuses)
{
    ...
    if (!m_apis.dash_tag_api->remove_src_tag_entries)
    {
        SWSS_LOG_INFO("remove_src_tag_entries is not supported");
        return SAI_STATUS_NOT_SUPPORTED;
    }

    return m_apis.dash_tag_api->remove_src_tag_entries(
            object_count,
            entries,
            mode,
            object_statuses);
