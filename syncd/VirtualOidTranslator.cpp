...
bool isInitViewMode(); // TODO move to shared module
        ...
        _In_ sai_object_id_t switchVid)
{
    ...
    sai_object_type_t object_type = sai_object_type_query(rid); // TODO move to std::function or wrapper class
    ...
    vid = redis_create_virtual_object_id(switchVid, object_type); // TODO to std::function or spearate object
